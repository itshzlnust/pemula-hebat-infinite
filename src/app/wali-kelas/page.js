...
export default function WaliKelasDashboardPage() {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-gray-100 dark:bg-gray-900">
            {/* Container untuk seluruh area konten utama, termasuk header dan kolom-kolom */}
            <div className="flex-1 flex flex-col p-4 md:p-6 gap-4 md:gap-6">

                {/* Header dipindahkan ke sini, di dalam container utama konten */}
                <header className="flex justify-between items-center"> {/* Dihapus: p-4, mb-4 md:mb-6 */}
                    <h1 className="text-xl md:text-2xl font-semibold text-gray-800 dark:text-white">
                        Dashboard Wali Kelas
                    </h1>
                    <motion.button
                        onClick={handleLogout}
                        className="bg-red-500 hover:bg-red-600 text-white font-semibold py-2 px-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-150 text-sm"
                ...
                {/* Container untuk dua kolom: sidebar dan konten utama */}
                <div className="flex flex-1 gap-4 md:gap-6"> {/* Dihapus: p-4 md:p-6 pt-0 */}
                    {/* Panel Kiri - Sidebar */}
                    <motion.aside
